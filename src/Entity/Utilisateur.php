...
class Utilisateur implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Groups(['utilisateur:read', 'bateau:read', 'message:read', 'avis:read', 'reservation:read', 'notification:read'])]
    private ?int $id = null;
    ...
    #[Groups(['utilisateur:read', 'bateau:read', 'message:read', 'reservation:read', 'notification:read'])]
